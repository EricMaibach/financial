...
**If State is `IDEATING`:** You are in active ideation mode. Orient refinements toward UX gaps relevant to the upcoming phase. Before posting any new discussion, check what features are already queued for human review — avoid proposing ideas that duplicate already-approved work:
